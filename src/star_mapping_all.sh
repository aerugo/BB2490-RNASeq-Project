...
mkdir -p /proj/g2015056/BB2490/proj5_ASE/BB2490-RNASeq-Project/data/star_mapping/20160302-starmapping
reference=/proj/g2015056/BB2490/proj5_ASE/BB2490-RNASeq-Project/data/star_index/20160226-starindex/
input=/proj/g2015056/BB2490/proj5_ASE/BB2490-RNASeq-Project/data/preprocessed_reads/20160302-trimgalore/
output=/proj/g2015056/BB2490/proj5_ASE/BB2490-RNASeq-Project/data/star_mapping/20160302-starmapping/
...
STAR --genomeDir ${reference} --runThreadN 8 --readFilesIn ${input}SN11_UNST_TTAGGC_L002_R1_001_val_1.fq ${input}SN11_UNST_TTAGGC_L002_R2_val_2.fq --outReadsUnmapped Fastx --outFileNamePrefix ${output}/SN11_UNST_TTAGGC_L002

STAR --genomeDir ${reference} --runThreadN 8 --readFilesIn ${input}SN11_UNST_TTAGGC_L003_R1_001_val_1.fq ${input}SN11_UNST_TTAGGC_L003_R2_val_2.fq --outReadsUnmapped Fastx --outFileNamePrefix ${output}/SN11_UNST_TTAGGC_L003

STAR --genomeDir ${reference} --runThreadN 8 --readFilesIn ${input}SN11_UNST_TTAGGC_L003_R1_001_val_1.fq ${input}SN11_UNST_TTAGGC_L004_R2_val_2.fq --outReadsUnmapped Fastx --outFileNamePrefix ${output}/SN11_UNST_TTAGGC_L004

STAR --genomeDir ${reference} --runThreadN 8 --readFilesIn ${input}SN11_UNST_TTAGGC_L003_R1_001_val_1.fq ${input}SN11_UNST_TTAGGC_L005_R2_val_2.fq --outReadsUnmapped Fastx --outFileNamePrefix ${output}/SN11_UNST_TTAGGC_L005
