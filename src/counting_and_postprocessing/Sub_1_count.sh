...
#SBATCH -A g2015056
#SBATCH -t 24:00:00
#SBATCH -J HTseq_subsample_1
#SBATCH -p core -n 6
#SBATCH -C thin
#SBATCH -e /proj/g2015056/nobackup/Subsample/Htseq/HTseq_Subsample_1_err.txt
#SBATCH -o /proj/g2015056/nobackup/Subsample/Htseq/HTSeq_Subsample_1_out.txt
...
input=/proj/g2015056/nobackup/Subsample/03_10_2016/subsample_1/
output=/proj/g2015056/nobackup/Subsample/Htseq/Subsample_1/
